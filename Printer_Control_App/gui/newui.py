...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        text_style_semibold = "font: 20pt ; font-weight: semibold;"
        text_style_regular = "font: 20pt ; font-weight: regular;"
        text_style_header = "font: 40pt ; font-weight: semi-bold;"
        blue_button = """
            QPushButton {
        ...
        clear_button = """
            QPushButton {
                ...
                /*may need to add transparent background*/
        ...
        clear_combobox = '''
            QComboBox {
                ...
                padding-left: 30px;  /* Corrected from 'padding left' */
                color: black;
                min-height: 30px;  /* Ensure consistent height */
            }

            QComboBox::drop-down { /* the drop-down box */
                border: 0px;
                background: transparent;
                width: 15px;  /* Consistent with the arrow size */
            }
            ...
            QComboBox::on { /* when the box is open */
                border: 2px solid black;
                background-color: lightgray;
            }

            QComboBox QListView { /* list menu */
                border: 1px solid black;  /* Match the button border */
                border-radius: 8px;  /* Match the button border radius */
                color: black;  /* Match the button text color */
                background-color: #E8F5FC;  /* Match the button background */
                padding: 5px;  /* Ensure padding for items */

            }
            QComboBox QListView::item { /* for items */
                padding: 5px;
                background-color: #E8F5FC;  /* Match the list background */
                color: black;  /* Match the text color */
            }

            QComboBox QListView::item:selected { /* when item is selected */
                background-color: #d3e0ea;  /* Light blue background for selected item */
                color: black;  /* Keep text color the same */
            }

            QComboBox QListView::item:hover { /* when item is hovered */
        ...
        tab_style =  """
            QTabWidget::pane { /* The tab widget frame */
                ...
                border: none;
                position: absolute;
                top: 0px; /* Adjust this value to raise the tabs */
                left: 0px;
            }
            ...
            QTabBar::tab:selected {
                ...
                color: white;
                border-color: #1B98E0; 
                margin-bottom: -2px; /* Overlap the tab content frame */
            }
"""
        radio_button = """ 
        ...
        self.printer_label.setStyleSheet("font: 40pt ; font-weight: semi-bold;")
        ...
        self.prt_stat_label.setStyleSheet("font: 12pt ; font-weight: bold; color: #E01B24;")
        ...
        self.con_stat_label.setStyleSheet("font: 12pt ; font-weight: bold; color: #E01B24;")
        ...
        self.coordinates_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; text-decoration: underline;")
        ...
        self.x_cord_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.y_cord_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.z_cord_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.prt_home_label.setStyleSheet("font: 12pt ; font-weight: bold; color: #E01B24;")
        ...
        self.temp_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; text-decoration: underline;")
        ...
        self.bed_temp_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.extruder_temp_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.lower_threshold_label.setStyleSheet("font: 20pt ; font-weight: semi-bold; qproperty-alignment: 'AlignCenter';")
        ...
        self.zero_at_label.setStyleSheet(text_style_regular)
        ...
        self.threshold_label.setStyleSheet(text_style_regular)
        ...
        self.cameras_label.setStyleSheet("font: 40pt ; font-weight: semi-bold; text-decoration: underline;")
        ...
        self.cam_number_label.setGeometry(QtCore.QRect(1240, 533, 75, 30))
        self.cam_number_label.setObjectName("cam_number_label")
        self.cam_number_label.setStyleSheet("font: 20pt ; font-weight: semi-bold; text-decoration: underline;")

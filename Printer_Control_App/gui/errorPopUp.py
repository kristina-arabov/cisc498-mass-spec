...
class ErrorPopUp(QDialog):
    def __init__(self, title, label, parent=None):
        ...
        self.setStyleSheet("background-color: #F7BABD;")
        ...
        self.x_label.setStyleSheet("color: white; font-size: 80px; font-weight: bold; border-radius: 61px; background-color: #E01B24; border: 1px solid #000000;")
        ...
        self.ok_button.setStyleSheet("background-color: #E01B24; color: white; font-size: 20px; border-radius: 15px; ")
...
if __name__ == '__main__':
    ...
    popup = ErrorPopUp('Error', 'Connection Error')
